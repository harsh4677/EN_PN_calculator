  ...
  return(
    <div className="flex justify-center items-center min-h-screen w-screen bg-gradient-to-b from-gray-800 to-gray-900">
      <form onSubmit={handleSubmit} className="bg-gray-700 p-8 rounded-lg shadow-2xl w-full max-w-7xl">
        <h1 className='text-white font-bold text-3xl'>PN</h1>
...
{/* 
          ...
          {showTraceElements && (
            <div className="w-1/4 bg-gray-800 p-6 rounded-lg shadow-lg">
              ...
              <ul className="space-y-2">
                <li className="hover:text-green-400 transition-colors text-lg font-semibold">Zinc: 3 mg</li>
                <li className="hover:text-green-400 transition-colors text-lg font-semibold">Copper: 300 mcg</li>
                <li className="hover:text-green-400 transition-colors text-lg font-semibold">Manganese (Mn): 55 mcg</li>
          ...
          {showMultivitamins && (
            <div className="w-1/4 bg-gray-800 p-6 rounded-lg shadow-lg">
              ...
              <ul className="space-y-2">
                <li className="hover:text-purple-400 transition-colors text-lg font-semibold">A: 3500 IU</li>
                <li className="hover:text-purple-400 transition-colors text-lg font-semibold">D3: 200 IU</li>
                <li className="hover:text-purple-400 transition-colors text-lg font-semibold">E: 11.2 IU</li>
                <li className="hover:text-purple-400 transition-colors text-lg font-semibold">K1: 150 mcg</li>
                <li className="hover:text-purple-400 transition-colors text-lg font-semibold">B1: 3.51 mg</li>
                <li className="hover:text-purple-400 transition-colors text-lg font-semibold">B2: 4.14 mg</li>
                <li className="hover:text-purple-400 transition-colors text-lg font-semibold">B6: 4.53 mg</li>
                <li className="hover:text-purple-400 transition-colors text-lg font-semibold">Vitamin C: 125 mg</li>
                <li className="hover:text-purple-400 transition-colors text-lg font-semibold">Folic Acid: 414 mcg</li>
                <li className="hover:text-purple-400 transition-colors text-lg font-semibold">Pantothenic Acid: 17.25 mg</li>
                <li className="hover:text-purple-400 transition-colors text-lg font-semibold">B12: 5.5 mcg</li>
                <li className="hover:text-purple-400 transition-colors text-lg font-semibold">Biotin: 69 mcg</li>
                <li className="hover:text-purple-400 transition-colors text-lg font-semibold">Niacin: 46 mg</li>
              </ul>
            </div>
          )}
        </div>
